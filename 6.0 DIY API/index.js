...
app.get("/random", (req, res) => {
    ...
    const x=Math.floor(Math.random()*jokes.length);
    res.json(jokes[x]);
...
app.get("/filter", (req, res) => {
    ...
    const activities=jokes.filter((joke) => joke.jokeType === type);
    res.json(activities);
...
app.put("/jokes/:id", (req, res) => {
   ...
   const x=jokes.findIndex((joke) => joke.id ===id);
   jokes[x]=jokeFound;
   res.json(jokeFound);
});
//6. PATCH a joke
